window.MANILA_API = (function () {
  ...
  return {
    ...
    createRoom: function (name, maxPlayers, decisionSeconds, gameMode) { return post('rooms/create', { name: name, maxPlayers: maxPlayers, decisionSeconds: decisionSeconds, gameMode: gameMode }); },
